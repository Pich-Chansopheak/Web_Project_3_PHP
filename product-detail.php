...
<?php
										...
										try{
											...
											if(!$code){
												...
												echo `<div class="alert alert-danger" role="alert">
														Item a;ready added to your cart!
											    		</div>`;
											}
		...
		try{
			...
			$stmt = $conn->prepare("SELECT * , tbcategory.cateName 
											FROM tbproducts
				...
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li class="<?=($page=="shop.php"?"active-menu":"")?>">
								<a href="index.php?p=shop" >Shop</a>
							</li>

							<li class="<?=($page=="blog.php"?"active-menu":"")?>">
								<a href="index.php?p=blog" >Blog</a>
							</li>

							<li class="<?=($page=="about.php"?"active-menu":"")?>">
								<a href="index.php?p=about" >About</a>
							</li>

							<li class="<?=($page=="contact.php"?"active-menu":"")?>">
...
<div class="sec-banner bg0 p-t-80 p-b-50 mt-5">
	<div class="container">
		...
		<div style="margin-left: 100px"></div>
			...
			<a href="index.php?p=shop" class="stext-109 cl8 hov-cl1 trans-04">
				<?=$row["cateName"]?>
				<i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
			</a>
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3">
									<div class="wrap-pic-w pos-relative">
										...
										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?=$row["proImg"]?>">
							...
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									...
									<form action="" class="form-submit">
										<input type="hidden" class="pro_id" value="<?=$row["proid"]?>">
										<input type="hidden" class="pro_name" value="<?=$row["proName"]?>">
										<input type="hidden" class="pro_price" value="<?=$row["proPrice"]?>">
										<input type="hidden" class="pro_img" value="<?=$row["proImg"]?>">
										<button class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail addToCart">
												Add to cart
											</button>
									</form>
			...
			<div class="bor10 m-t-50 p-t-43 p-b-40">
				...
				<div class="tab01">
					...
					<ul class="nav nav-tabs" role="tablist">
						...
						<li class="nav-item p-b-10">
							<a class="nav-link" data-toggle="tab" href="#reviews" role="tab">Reviews (<?=$row["proReview"]?>)</a>
						</li>
					</ul>

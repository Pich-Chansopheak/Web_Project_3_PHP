...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item <?=($page=="product.php"?"active":"")?>">
                  <a href="index.php?p=product" class="menu-link">
            ...
            <!-- user -->
            <li class="menu-item <?=($page=="user.php"?"active":"")?>">
                  <a href="index.php?p=user" class="menu-link">
            ...
            <li class="menu-item">
                  <a href="logout.php" class="menu-link">
                    <i class='menu-icon bx bxs-door-open'></i>
